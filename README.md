Code of [each step](https://github.com/eidiot/TDD-GameLife-AndroidStudio/releases) for [TDD Demo GameOfLife with Android Studio](http://eidiot.me/2014/09/06/TDD-Demo-GameOfLife-with-Android-Studio/)
 
- [Create GameOfLife Project](https://github.com/eidiot/TDD-GameLife-AndroidStudio/releases/tag/01CreateProject)
- [Create class `GameModel` and test case `GameModelTest`](https://github.com/eidiot/TDD-GameLife-AndroidStudio/releases/tag/02TestCase)
...
- [`GameModel` initialisation](https://github.com/eidiot/TDD-GameLife-AndroidStudio/releases/tag/03Init) 
...
- [`GameModel.isAlive()`](https://github.com/eidiot/TDD-GameLife-AndroidStudio/releases/tag/04IsAlive)
...
- [`GameModel.makeAlive()`](https://github.com/eidiot/TDD-GameLife-AndroidStudio/releases/tag/05MakeAlive)
...
- [Test out of map](https://github.com/eidiot/TDD-GameLife-AndroidStudio/releases/tag/06OutOfMap)
...
- [`GameModel.makeDead()`](https://github.com/eidiot/TDD-GameLife-AndroidStudio/releases/tag/07MakeDead)
...
- [Rule 1 to Rule 3](https://github.com/eidiot/TDD-GameLife-AndroidStudio/releases/tag/08Rule1To3)
...
- [Rule 4](https://github.com/eidiot/TDD-GameLife-AndroidStudio/releases/tag/09Rule4)
...
- [`GameModel.next()`](https://github.com/eidiot/TDD-GameLife-AndroidStudio/releases/tag/10Next)
...
- [GameView](https://github.com/eidiot/TDD-GameLife-AndroidStudio/releases/tag/11GameView)
...
- [Run the game and Glider demo](https://github.com/eidiot/TDD-GameLife-AndroidStudio/releases/tag/12Glider)
